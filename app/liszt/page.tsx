    ...
    <div>
      ...
      <div className="flex flex-col gap-8 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-64 2xl:px-96 py-12 lg:py-16 sm:text-lg font-mono tracking-wide text-justify">
        ...
        <p>
          ...
          through the entire piece except at one place. Some pianists are
          tempted to add a bottom B for extra <i>oomph</i> in the
          recapitulation, although Leslie Howard might slap you on the wrist for
          it.
        </p>
        <p>
          ...
          enabling this impossible cadence. On the final note of the piece we
          get the only occurrence of the bottom B on the piano: the scale is
          finally resolved.
        </p>
      </div>
    </div>
