...
<div class="max-w-3xl">
	<section class="mb-8 flex flex-wrap">
		...
		<div class="grow">
			<button class="float-right btn" on:click={() => nameModal.showModal()}> Change </button>
		</div>
	</section>
	...
	{#if true}
		<section>
			...
			<div class="grow">
				<button class="float-right btn" on:click={() => emailModal.showModal()}> Change </button>
			</div>
		</section>
		<section>
			<hgroup>
			...
			<div class="grow">
				<button class="float-right btn" on:click={() => passwordModal.showModal()}> Change </button>
			</div>
		</section>
	{/if}
